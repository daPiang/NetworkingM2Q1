...
public class BasicSpawner : MonoBehaviour, INetworkRunnerCallbacks
{
    ...
    [SerializedDictionary("Player Reference", "Network Object"), SerializeField]
    private SerializableDictionary<PlayerRef, NetworkObject> _serializedSpawnedCharacters = new();
